...
<div class="card-container">
    <% for (Courses course : allCourses) { %>
        <div class="card">
            ...
            <p>Instructor: <strong><%= course.getInstructor_id().getUsername() %></strong></p>
            <p>Category: <%= course.getCategory_id().getName() %></p>
            <p>Duration: <%= course.getDuration() %> hrs</p>
            <p>Languages: <%= String.join(", ", course.getLanguage()) %></p>
            <p class="price">₹<%= course.getDiscounted_price() %> 
...
%>
    <div class="section-title">Courses by <%= instructorName %></div>
    <div class="card-container">
